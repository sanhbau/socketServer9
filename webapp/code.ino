...
const char* ssid = "Thanh Thy";
const char* password = "14092003";
//const char* ssid = "Kuken";          //Tên mạng Wifi mà Socket server của bạn đang kết nối
//const char* password = "phuonghnhb";
//const char* ssid = "TP-LINK_3842C2";          //Tên mạng Wifi mà Socket server của bạn đang kết nối
//const char* password = "26673714";  //Pass mạng wifi ahihi, anh em rãnh thì share pass cho mình với.
 
char host[] = "vast-coast-12986.herokuapp.com";  //Địa chỉ IP dịch vụ, hãy thay đổi nó theo địa chỉ IP Socket server của bạn.
